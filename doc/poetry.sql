CREATE DATABASE IF NOT EXISTS  `poem` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;




DROP TABLE IF EXISTS `poem`.`user`;

CREATE TABLE `poem`.`user` (
...
DROP TABLE IF EXISTS `poem`.`article`;

CREATE TABLE `poem`.`article` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`comment`;

CREATE TABLE `poem`.`comment` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`sort`;

CREATE TABLE `poem`.`sort` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`label`;

CREATE TABLE `poem`.`label` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `sort_id` int NOT NULL COMMENT '分类ID',
...
DROP TABLE IF EXISTS `poem`.`tree_hole`;

CREATE TABLE `poem`.`tree_hole` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `avatar` varchar(256) DEFAULT NULL COMMENT '头像',
...
DROP TABLE IF EXISTS `poem`.`wei_yan`;

CREATE TABLE `poem`.`wei_yan` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` int NOT NULL COMMENT '用户ID',
  `like_count` int NOT NULL DEFAULT 0 COMMENT '点赞数',
...
DROP TABLE IF EXISTS `poem`.`web_info`;

CREATE TABLE `poem`.`web_info` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`resource_path`;

CREATE TABLE `poem`.`resource_path` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`resource`;

CREATE TABLE `poem`.`resource` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` int NOT NULL COMMENT '用户ID',
  `type` varchar(32) NOT NULL COMMENT '资源类型',
...
DROP TABLE IF EXISTS `poem`.`history_info`;

CREATE TABLE `poem`.`history_info` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`sys_config`;

CREATE TABLE `poem`.`sys_config` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`family`;

CREATE TABLE `poem`.`family` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` int NOT NULL COMMENT '用户ID',
...
DROP TABLE IF EXISTS `poem`.`im_chat_user_friend`;

CREATE TABLE `poem`.`im_chat_user_friend` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` int NOT NULL COMMENT '用户ID',
...
DROP TABLE IF EXISTS `poem`.`im_chat_group`;

CREATE TABLE `poem`.`im_chat_group` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`im_chat_group_user`;

CREATE TABLE `poem`.`im_chat_group_user` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
...
DROP TABLE IF EXISTS `poem`.`im_chat_user_message`;

CREATE TABLE `poem`.`im_chat_user_message` (
...
DROP TABLE IF EXISTS `poem`.`im_chat_user_group_message`;

CREATE TABLE `poem`.`im_chat_user_group_message` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `group_id` int NOT NULL COMMENT '群ID',
  `from_id` int NOT NULL COMMENT '发送ID',
...
INSERT INTO `poem`.`user`(`id`, `username`, `password`, `phone_number`, `email`, `user_status`, `gender`, `open_id`, `admire`, `subscribe`, `avatar`, `introduction`, `user_type`, `update_by`, `deleted`) VALUES (1, 'Sara', '47bce5c74f589f4867dbd57e9ca9f808', '', '', 1, 1, '', '', '', '', '', 0, 'Sara', 0);

INSERT INTO `poem`.`web_info`(`id`, `web_name`, `web_title`, `notices`, `footer`, `background_image`, `avatar`, `random_avatar`, `random_name`, `random_cover`, `waifu_json`, `status`) VALUES (1, 'Sara', 'poem', '[]', '云想衣裳花想容， 春风拂槛露华浓。', '', '', '[]', '[]', '[]', '{}', 1);

INSERT INTO `poem`.`family` (`id`, `user_id`, `bg_cover`, `man_cover`, `woman_cover`, `man_name`, `woman_name`, `timing`, `countdown_title`, `countdown_time`, `status`, `family_info`, `like_count`, `create_time`, `update_time`) VALUES (1, 1, '背景封面', '男生头像', '女生头像', 'Sara', 'Abby', '2000-01-01 00:00:00', '春节倒计时', '2025-01-29 00:00:00', 1, '', 0, '2000-01-01 00:00:00', '2000-01-01 00:00:00');

INSERT INTO `poem`.`im_chat_group` (`id`, `group_name`, `master_user_id`, `introduction`, `notice`, `in_type`) VALUES(-1, '公共聊天室', 1, '公共聊天室', '欢迎光临！', 0);

insert into `poem`.`im_chat_group_user` (`id`, `group_id`, `user_id`, `admin_flag`, `user_status`) values(1, -1, 1, 1, 1);




INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (1, 'QQ邮箱号', 'spring.mail.username', '', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (2, 'QQ邮箱授权码', 'spring.mail.password', '', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (3, '邮箱验证码模板', 'user.code.format', '【poem】%s为本次验证的验证码，请在5分钟内完成验证。为保证账号安全，请勿泄漏此验证码。', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (4, '邮箱订阅模板', 'user.subscribe.format', '【poem】您订阅的专栏【%s】新增一篇文章：%s。', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (5, '默认存储平台', 'store.type', 'local', '2');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (6, '本地存储启用状态', 'local.enable', 'true', '2');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (7, '七牛云存储启用状态', 'qiniu.enable', 'false', '2');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (8, '本地存储上传文件根目录', 'local.uploadUrl', '/home/file/', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (9, '本地存储下载前缀', 'local.downloadUrl', '仿照：【https://poem.cn/static/】，将域名换成自己的服务器ip或域名', '2');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (10, '七牛云-accessKey', 'qiniu.accessKey', '', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (11, '七牛云-secretKey', 'qiniu.secretKey', '', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (12, '七牛云-bucket', 'qiniu.bucket', '', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (13, '七牛云-域名', 'qiniu.downloadUrl', '仿照：【https://file.poem.cn/】，将域名换成自己的七牛云ip或域名', '2');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (15, 'IM-聊天室启用状态', 'im.enable', 'true', '1');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (16, '七牛云上传地址', 'qiniuUrl', 'https://upload.qiniup.com', '2');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (17, '备案号', 'beian', '', '2');
INSERT INTO `poem`.`sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`) VALUES (18, '前端静态资源路径前缀', 'webStaticResourcePrefix', '仿照：【https://poem.cn/static/】', '2');
